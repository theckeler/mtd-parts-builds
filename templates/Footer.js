"use client";
import FooterLegal from "@/components/Footer/Footer";
  ...
  return (
    <footer>
      ...
      <div className="container">
        <ul
          className={setup.ul.className}
          style={setup.ul.style}
        >
          <li
            className={setup.ul.li.className}
            style={setup.ul.li.style}
          >
            <FooterNoDropdown
              title="Home"
              href="/"
