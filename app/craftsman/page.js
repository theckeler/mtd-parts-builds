            ...
            faqs={[
              {
                ...
                className: "font-bold",
                answer: `When buying a lawn mower, there are several factors to consider including lawn size, terrain, and power source. CRAFTSMAN offers a wide selection of mowers including <a href="https://www.craftsman.com/collections/riding-lawn-mowers-1" class="text-black">riding lawn mowers</a>, <a href="https://www.craftsman.com/collections/zero-turn-mowers"  class="text-black">zero-turn mowers</a> and <a href="https://www.craftsman.com/collections/walk-behind-mowers"  class="text-black">walk-behind mowers</a>. To find the mower best suited for your yard, check out our <a href="https://www.craftsman.com/pages/mower-finder"  class="text-black">CRAFTSMAN Mower Finder</a>. To learn more about the differences between various types of mowers, check out our lawn mower <a href="https://www.craftsman.com/blogs/news/lawn-mowers-frequently-asked-questions" class="text-black">FAQs</a>.`,
              },
              {
                question: "What is the best CRAFTSMAN® snow blower for me?",
                className: "font-bold",
                answer: `When selecting a snow blower, there are several considerations to keep in mind including snowfall amounts and frequency, terrain, and the size of the area to be cleared. To find the snow blower best suited for your yard, check out our <a href="https://www.craftsman.com/pages/snow-blower-finder" class="text-black">Snow Blower Finder</a>. To learn more about considerations when selecting a snow blower, check out our snow blower <a href="https://www.craftsman.com/blogs/news/snow-blowers-frequently-asked-questions" class="text-black">FAQs</a>. Shop all CRAFTSMAN snow blowers <a href="https://www.craftsman.com/collections/snow-blowers?_pos=2&_psq=snow+b&_ss=e&_v=1.0" class="text-black">HERE</a>.`,
              },
              {
                question: "How do I register my CRAFTSMAN® Equipment?",
                className: "font-bold",
                answer: `To register your CRAFTSMAN equipment, you need to create a CRAFTSMAN® Club account <a href=" https://www.craftsman.com/account/register" class="text-black">HERE</a>.`,
              },
            ]}
            id="craftsman-faqs"
            className="font-bold"
