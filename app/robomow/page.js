      ...
      <section className={`${pageSetup.colors.background} py-12`}>
        <div className="container">
          ...
          <p className="text-center">
            Find the {pageSetup.brandName} original equipment parts and
            accessories you need to keep your lawn mower, snow blower and other
            outdoor power equipment performing strong. These parts and
            accessories are designed and engineered to exact standards to
            provide reliability, safety and top performance. Protect your{" "}
            {pageSetup.brandName} outdoor power product investment with{" "}
            {pageSetup.brandName} original equipment parts and accessories.
          </p>
          ...
          <ul className="grid gap-4 lg:grid-cols-2">
            <li className="h-full">
              ...
              <div className="bg-white p-2 part_num-container">
                ...
                <a href="https://www.mtdparts.com/en_US/how-to-find-model-number.html">
